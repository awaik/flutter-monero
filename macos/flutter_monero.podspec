...
# Run `pod lib lint flutter_monero.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_monero'
  s.version          = '0.0.1'
...
#     openssl.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/external/include/**" }
...
#   s.subspec 'Crypto' do |crypto|
#     crypto.preserve_paths = 'external/include/**/*.h'
#     crypto.vendored_libraries = 'external/lib/libcrypto.a'
#     crypto.libraries = 'crypto'
#     crypto.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/external/include/**" }
#     crypto.pod_target_xcconfig = { "OTHER_LDFLAGS" => "-force_load '$(PODS_TARGET_SRCROOT)/external/lib/libcrypto.a'" }
#   end

#   s.subspec 'Ssl' do |ssl|
#     ssl.preserve_paths = 'external/include/**/*.h'
#     ssl.vendored_libraries = 'external/lib/libssl.a'
#     ssl.libraries = 'ssl'
#     ssl.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/external/include/**" }
#     ssl.pod_target_xcconfig = { "OTHER_LDFLAGS" => "-force_load '$(PODS_TARGET_SRCROOT)/external/lib/libssl.a'" }
#   end
...
#     sodium.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/external/include/**" }
...
#   end
  ...
  s.subspec 'Unbound' do |unbound|
    ...
    unbound.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/external/include/**" }
  ...
  s.subspec 'Boost' do |boost|
    ...
    boost.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/external/include/**" }
