...
A new Flutter FFI plugin project.
  ...
  s.subspec 'OpenSSL' do |openssl|
    ...
    openssl.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/macos/external/include/**" }
  ...
  s.subspec 'Sodium' do |sodium|
    ...
    sodium.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/macos/external/include/**" }
  ...
  s.subspec 'Unbound' do |unbound|
    ...
    unbound.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/macos/external/include/**" }
  ...
  s.subspec 'Boost' do |boost|
    ...
    boost.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/macos/external/include/**" }
  ...
  s.subspec 'Monero' do |monero|
    ...
    monero.xcconfig = { 'HEADER_SEARCH_PATHS' => "${PODS_ROOT}/macos/external/include" }
